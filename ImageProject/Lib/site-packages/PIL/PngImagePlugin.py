...
# 1998-07-12 fl   Read/write 16-bit img as mode I (0.4)
...
# 2008-08-13 fl   Added tRNS support for RGB img
...
def _save(im, fp, filename, chunk=putchunk, save_all=False):
    ...
    if mode == "P":
        #
        # attempt to minimize storage requirements for palette img
