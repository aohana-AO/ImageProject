...
OPEN_INFO = {
    ...
    (II, 6, (1,), 1, (8,), ()): ("L", "L"),
    (MM, 6, (1,), 1, (8,), ()): ("L", "L"),
    # JPEG compressed img handled by LibTiff and auto-converted to RGBX
    # Minimal Baseline TIFF requires YCbCr img to have 3 SamplesPerPixel
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _setup(self):
        ...
        # old style jpeg compression img most certainly are YCbCr
        ...
        if self.use_load_libtiff:
            ...
            # so large g4 img will fail if we use that
            # function.
            #
            ...
            # YCbCr img with new jpeg compression with pixels in one plane
...
def _save(im, fp, filename):
    ...
    # required for color libtiff img
